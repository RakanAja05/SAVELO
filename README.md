...
- Budget-first itinerary generator dalam 3 gaya: Hemat, Seimbang, Experience.
- Filter aksesibilitas terverifikasi untuk perjalanan yang inklusif.
- Discovery map untuk eksplorasi destinasi dan UMKM lokal.
- Destination card kaya konteks dengan AI MicroStory.
- Eco Tracker untuk pelacakan dampak transportasi.
- PathPoints sebagai gamifikasi dan reward.

## Detail Fitur

### 01. Budget First Planner
